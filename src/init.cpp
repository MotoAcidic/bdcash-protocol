...
// Copyright (c) 2020-2021 The BDCASH developers
...
std::string HelpMessage(HelpMessageMode mode)
{
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "bdcashd.pid"));
#endif
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcoins, mempool, net, bdcash, (obfuscation, swifttx, masternode, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all BDCASH specific functionality (Masternodes, Obfuscation, SwiftTX, Budgeting) (0-1, default: %u)"), 0));
    ...
    strUsage += HelpMessageOpt("-anonymizebdcashamount=<n>", strprintf(_("Keep N BDCASH anonymized (default: %u)"), 0));
...
// ********************************************************* Step 8: load wallet
    ...
    nAnonymizeBDCASHAmount = GetArg("-anonymizebdcashamount", 0);
    ...
    LogPrintf("Anonymize BDCASH Amount %d\n", nAnonymizeBDCASHAmount);
