...
In order to support loading of multiple wallets in bdcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bdcash.cpp.
...
Changes to bdcash.cpp
----------------------
bdcash.cpp is the entry point into bdcash-qt, and as such, will require some minor modifications to provide hooks for
