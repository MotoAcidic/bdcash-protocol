...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeBDCASH = new QSpinBox(tabMain);
        anonymizeBDCASH->setObjectName(QStringLiteral("anonymizeBDCASH"));
        anonymizeBDCASH->setMinimumSize(QSize(36, 36));
        anonymizeBDCASH->setMinimum(100);
        anonymizeBDCASH->setMaximum(100000);
        anonymizeBDCASH->setSingleStep(100);
        anonymizeBDCASH->setValue(1000);

        horizontalLayout->addWidget(anonymizeBDCASH);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start BIGDATACASH after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start BIGDATACASH on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of BIGDATACASH to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the BIGDATACASH client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the BIGDATACASH network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting BIGDATACASH.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/bigdatacash-project/bigdatacash-project-translations", 0));
