/* src/config/bdcash-config.h.  Generated from bdcash-config.h.in by configure.  */
/* src/config/bdcash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "BDCASH Core 1.7.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Bdcash Protocol"
