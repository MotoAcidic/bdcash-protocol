...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BDCASH);
    ...
    if (!settings.contains("nAnonymizeBDCASHAmount"))
        settings.setValue("nAnonymizeBDCASHAmount", 1000);

    nObfuscationRounds = settings.value("nObfuscationRounds").toLongLong();
    nAnonymizeBDCASHAmount = settings.value("nAnonymizeBDCASHAmount").toLongLong();
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeBDCASHAmount:
            return QVariant(nAnonymizeBDCASHAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case ObfuscationRounds:
            ...
            break;
        case AnonymizeBDCASHAmount:
            nAnonymizeBDCASHAmount = value.toInt();
            settings.setValue("nAnonymizeBDCASHAmount", nAnonymizeBDCASHAmount);
            emit anonymizeBDCASHAmountChanged(nAnonymizeBDCASHAmount);
            break;
        case CoinControlFeatures:
