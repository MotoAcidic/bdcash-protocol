...
/** Utility functions used by the BDCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render BDCASH addresses in monospace font
...
// Parse "bdcash:" URI into recipient object, return true on successful parsing
