...
This means one can have an always-on apollond instance running, and another local apollond/bdcash-qt instance which connects to this node and receives blocks from it.
