...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BDCASH bigdatacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bigdatacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bigdatacash transaction") + "\n" +
                               "  bigdatacash-tx [options] -create [commands]   " + _("Create hex-encoded bigdatacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bigdatacash transaction
