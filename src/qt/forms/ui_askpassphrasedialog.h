...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->resize(598, 261);
        ...
        passLabel1->setMinimumSize(QSize(0, 32));
        ...
        passEdit1->setMinimumSize(QSize(0, 36));
        ...
        passLabel2->setMinimumSize(QSize(0, 32));
        ...
        passEdit2->setMinimumSize(QSize(0, 36));
        ...
        passEdit3->setMinimumSize(QSize(0, 36));
        ...
        passLabel3->setMinimumSize(QSize(0, 32));
