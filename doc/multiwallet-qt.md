...
In order to support loading of multiple wallets in bigdatacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bigdatacash.cpp.
...
Changes to bigdatacash.cpp
----------------------
bigdatacash.cpp is the entry point into bigdatacash-qt, and as such, will require some minor modifications to provide hooks for
