...
This means one can have an always-on bdcashd instance running, and another local bdcashd/bdcash-qt instance which connects to this node and receives blocks from it.
