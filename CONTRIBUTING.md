...
[Translation Process](https://github.com/bdcash-project/bdcash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BDCASH Core project, and is not to be
confused with overall BDCASH Network Protocol consensus changes.

Whether a pull request is merged into BDCASH Core rests with the project merge
...
Patches that change BDCASH consensus rules are considerably more involved than
...
Where a patchset proposes to change the BDCASH consensus, it must have been
...
The project leader is the release manager for each BDCASH Core release.
