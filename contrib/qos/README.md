...
This means one can have an always-on apollond instance running, and another local apollond/apollon-qt instance which connects to this node and receives blocks from it.
