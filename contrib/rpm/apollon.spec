...
issuing of apollons is carried out collectively by the network.
...
%description libs
This package provides the apollonconsensus shared libraries. These libraries
...
apollonconsensus shared library. If you are developing or compiling software
...
mv %{buildroot}%{_bindir}/apollond %{buildroot}%{_sbindir}/apollond
...
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/apollon128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/apollon256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/apollon256.png %{buildroot}%{_datadir}/pixmaps/apollon16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/apollon256.png %{buildroot}%{_datadir}/pixmaps/apollon32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/apollon256.png %{buildroot}%{_datadir}/pixmaps/apollon64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/apollon256.png %{buildroot}%{_datadir}/pixmaps/apollon128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/apollon256.png %{buildroot}%{_datadir}/pixmaps/apollon256.xpm
...
%{_sbindir}/semanage port -a -t apollon_port_t -p tcp 18332
